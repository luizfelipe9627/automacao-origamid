...
function pluginsJS() {  
  ...
  return (
    gulp
      // O src é o caminho para encontrar o(s) arquivo(s) js, nesse caso está passando um array com o caminho dos arquivos. O "*" é para indicar que é para procurar por todos os arquivos que terminam com .js.
      .src([
        "node_modules/jquery/dist/jquery.min.js",
        "node_modules/moment/min/moment.min.js",
        "js/plugins/*.js",
      ])
      // O pipe é responsável por encadear as funções, nesse caso está chamando o concat e passa como parâmetro o nome do arquivo de saída, que é o plugins.js.
...
function compilaSass(compresso) {
  // Sempre quando queremos modificar um arquivo tem que usar o return.
  return (
    gulp
...
function watch() {
  ...
  // O watch é responsável por observar os arquivos, nesse caso está observando o arquivo js, quando houver alteração ele executa a função pluginsJS. O "*" é para indicar que é para procurar por todos os arquivos que terminam com .js.
...
// Está exportando as funções para ser usado em qualquer parte do arquivo.
